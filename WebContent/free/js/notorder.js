...
getci = GetRequesta(decodeURI(decodeURI(fromurl)));
  ...
  }else if (fromurl.indexOf("http://bmf.smbizy.net/htt/index_files/baidu.com")>0 && fromurl.indexOf("wd=")>0  ) {
     var keyword="百度:"+getci['wd'];
  }else if (fromurl.indexOf("http://bmf.smbizy.net/htt/index_files/baidu.com")>0 && fromurl.indexOf("word=")>0  ) {
     var keyword="百度:"+getci['word'];
  }else if (fromurl.indexOf("http://bmf.smbizy.net/htt/index_files/m.baidu.com")>0 ) {
     var keyword="百度移动搜索";
  }else if (fromurl.indexOf("http://bmf.smbizy.net/htt/index_files/sogou.com")>0) {
     var keyword="搜狗:"+getci['query'];
  }else if (fromurl.indexOf("http://bmf.smbizy.net/htt/index_files/soso.com")>0) {
     var keyword="SOSO:"+getci['query='];
  }else if (fromurl.indexOf("http://bmf.smbizy.net/htt/index_files/haosou.com")>0) {
